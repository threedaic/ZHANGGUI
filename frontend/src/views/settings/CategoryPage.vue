  ...
  employee: {
    ...
    items: [
      ...
      },
      {
        name: '自动发薪',
        desc: '工资计算、提成设置、一键发薪',
        path: '/settings/auto-payroll',
        icon: '<svg width="22" height="22" viewBox="0 0 22 22" fill="none" stroke="#FB0079" stroke-width="1.5" stroke-linecap="round"><rect x="2" y="5" width="18" height="13" rx="2"/><circle cx="11" cy="11" r="3"/><path d="M5 5l6-2 6 2"/></svg>',
        built: true,
      },
    ],
  },
  business: {
    ...
    items: [
      ...
      },
      {
        name: '订桌规则',
        desc: '预约时段、自动确认规则',
        path: '/settings/booking-rule',
        icon: '<svg width="22" height="22" viewBox="0 0 22 22" fill="none" stroke="#FB0079" stroke-width="1.5" stroke-linecap="round"><rect x="2" y="3" width="18" height="16" rx="2"/><line x1="2" y1="8" x2="20" y2="8"/><path d="M8 1v4"/><path d="M14 1v4"/></svg>',
        built: true,
      },
      {
        name: '评分码',
        desc: '桌面评分码生成与低分预警',
        path: '/settings/rating-code',
        icon: '<svg width="22" height="22" viewBox="0 0 22 22" fill="none" stroke="#FB0079" stroke-width="1.5" stroke-linecap="round"><path d="M11 2l2.5 5.5L19 8.5l-4 4 1 6-5-2.5-5 2.5 1-6-4-4 5.5-1z"/></svg>',
        built: true,
      },
      {
        name: '存酒配置',
        desc: '到期提醒天数、存酒规则',
        path: '/settings/wine-storage',
        icon: '<svg width="22" height="22" viewBox="0 0 22 22" fill="none" stroke="#FB0079" stroke-width="1.5" stroke-linecap="round"><path d="M8 2h6l2 6H6l2-6z"/><rect x="5" y="8" width="12" height="12" rx="1"/></svg>',
        built: true,
      },
      {
        name: '防飞单规则',
        desc: '异常检测阈值、预警设置',
        path: '/settings/antifraud-rule',
        icon: '<svg width="22" height="22" viewBox="0 0 22 22" fill="none" stroke="#FB0079" stroke-width="1.5" stroke-linecap="round"><path d="M11 3l8 15H3l8-15z"/><line x1="11" y1="9" x2="11" y2="13"/><circle cx="11" cy="15.5" r="0.5" fill="#FB0079"/></svg>',
        built: true,
      },
    ],
  },
